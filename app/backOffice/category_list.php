    ...
    <main class="bo-main">
        ...
        <div class="bo-content">
            <div class="bo-actions">
                <a href="/categories/add" class="btn btn-primary">Ajouter une catégorie</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-actions">
                            <a href="/categories/edit?id=<?= $category['id'] ?>" class="btn-icon" title="Modifier"><svg class="svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>
                            <a href="/categories/delete?id=<?= $category['id'] ?>" class="btn-icon text-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette catégorie ?')" title="Supprimer"><svg class="svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <div class="empty-state">
                <p>Aucune catégorie pour le moment. <a href="/categories/add">Créer une catégorie</a></p>
            </div>
            <?php endif; ?>
        </div>
    </main>
