...
<div class="bo-layout">
    <aside class="bo-sidebar">
        ...
        <nav class="bo-nav">
            <a href="/dashboard" class="active"><svg class="svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg> Dashboard</a>
    ...
    <main class="bo-main">
        <header class="bo-header">
            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                ...
                <div style="display: flex; align-items: center; gap: 20px;">
                    ...
                    <a href="/logout" style="background: #dc3545; color: white; padding: 8px 16px; border-radius: 5px; text-decoration: none; font-size: 14px; border: none; cursor: pointer;">Déconnexion</a>
                </div>
            </div>
        </header>
        ...
        <div class="bo-content">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-actions">
                            <a href="/edit?id=<?= $a['id'] ?>" class="btn-icon" title="Modifier"><svg class="svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>
                            <a href="/delete?id=<?= $a['id'] ?>" class="btn-icon text-danger" onclick="return confirm('Êtes-vous sûr ?')" title="Supprimer"><svg class="svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <div class="empty-state">
                <p>Aucun article pour le moment. <a href="/add">Créer un article</a></p>
            </div>
            <?php endif; ?>
        </div>
    </main>
